...
<html lang="en">
    ...
    <body>
        ...
        <header class="header">
            ...
            $filter = $_GET['subdit'];
            if ($_GET['by'] == 'jenis' && $_GET['subdit'] == 'Magelang') {
            ...
            }elseif (($_GET['subdit'] == 'Magelang' && $_GET['by'] == 'bulan')) {
...
<?php
                        ...
                        if (in_array($filter,$jenis)){
                           ...
                           $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Magelang%' AND `Jenis Tindak Pidana` = '$filter'");    
                        }elseif (in_array($filter, $bulan)){
                            $monthName = $filter ; // Indonesian month name
		                    $filter =  array_search($monthName, $bulan) + 1;
                            $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Magelang%' AND `Waktu Kejadian`LIKE '%2023%$filter-%' ");
                        }else{
                            $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Magelang%'");
                        }
?>

<main>
    <div class="map-container">
    <h1><strong>Peta Kriminalis Kabupaten Magelang</strong></h1>
        <a href="/detail.php">
        ...
        elseif ($_GET['subdit']=='Magelang' or ($_GET['subdit']=='Magelang' and$_GET['by'] == 'jenis') or ($_GET['subdit']=='Magelang' and$_GET['by'] == 'bulan') ) {echo '';}
        ?>


        <?php
        // bulan
        if (in_array($_GET['subdit'],$bulan) or ($_GET['subdit']=='Magelang' and$_GET['by'] == 'bulan')){
        echo "<table>
          <thead>
            <tr>
                <th>No.</th>
      ...
      //			echo  $row["ID"]. $row["Nama Kasus"].  $row["Jenis Tindak Pidana"].   $row["Waktu Kejadian"].  $row["Lokasi Kejadian"]. "<br>";
        ...
        }elseif (($_GET['by'] == 'jenis' and $_GET['subdit'] == 'Magelang') or in_array($_GET['subdit'],$jenis)) {
        // jenis
        echo "<table>
          <thead>
            <tr>
...
?>        
        ...
        }).fitBounds([[-7.653115823351175,110.09536457863],[-7.326771290760194,110.553042886532]]);
        ...
        function style_Batas_Kecamatan_BIG_0_0(feature) {
            if (feature.properties['OBJECTID'] >= 515.000000 && feature.properties['OBJECTID'] <= 1021.666667 ) {
                return {
            ...
            if (feature.properties['OBJECTID'] >= 1021.666667 && feature.properties['OBJECTID'] <= 1226.142857 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(223,55,42,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 1226.142857 && feature.properties['OBJECTID'] <= 1601.571429 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 1601.571429 && feature.properties['OBJECTID'] <= 1871.476190 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(238,114,69,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 1871.476190 && feature.properties['OBJECTID'] <= 2244.047619 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2244.047619 && feature.properties['OBJECTID'] <= 2355.714286 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2355.714286 && feature.properties['OBJECTID'] <= 3397.333333 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 3397.333333 && feature.properties['OBJECTID'] <= 4050.952381 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4050.952381 && feature.properties['OBJECTID'] <= 4136.285714 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4136.285714 && feature.properties['OBJECTID'] <= 4183.047619 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(255,239,172,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 4183.047619 && feature.properties['OBJECTID'] <= 4243.047619 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4243.047619 && feature.properties['OBJECTID'] <= 4363.857143 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(238,248,186,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 4363.857143 && feature.properties['OBJECTID'] <= 4868.047619 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4868.047619 && feature.properties['OBJECTID'] <= 5472.000000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(205,235,175,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 5472.000000 && feature.properties['OBJECTID'] <= 5510.857143 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5510.857143 && feature.properties['OBJECTID'] <= 5609.428571 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5609.428571 && feature.properties['OBJECTID'] <= 5728.476190 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5728.476190 && feature.properties['OBJECTID'] <= 6233.142857 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(120,185,173,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 6233.142857 && feature.properties['OBJECTID'] <= 6758.857143 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 6758.857143 && feature.properties['OBJECTID'] <= 6868.952381 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(69,149,182,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 6868.952381 && feature.properties['OBJECTID'] <= 7388.000000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
...
<div class="title">
<h1><strong><?php if (in_array($_GET['subdit'],$jenis) or ($_GET['subdit'] == 'Magelang' and $_GET['by'] == 'jenis')){echo 'Berdasarkan Bidang Tindak Pidana';}elseif (in_array($_GET['subdit'],$bulan) or ($_GET['by'] == 'bulan' and $_GET['subdit'] == 'Magelang')  ){echo 'Berdasarkan Waktu';} ?></strong></h1>
      </div>
<br>
</main>
