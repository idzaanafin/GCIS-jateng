...
<html lang="en">
    ...
    <body>
        ...
        <header class="header">
            ...
            $filter = $_GET['subdit'];
            if ($_GET['by'] == 'jenis' && $_GET['subdit'] == 'Banjarnegara') {
            ...
            }elseif (($_GET['subdit'] == 'Banjarnegara' && $_GET['by'] == 'bulan')) {
...
<?php
                        ...
                        if (in_array($filter,$jenis)){
                           ...
                           $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Banjarnegara%' AND `Jenis Tindak Pidana` = '$filter'");    
                        }elseif (in_array($filter, $bulan)){
                            $monthName = $filter ; // Indonesian month name
		                    $filter =  array_search($monthName, $bulan) + 1;
                            $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Banjarnegara%' AND `Waktu Kejadian`LIKE '%2023%$filter-%' ");
                        }else{
                            $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Banjarnegara%'");
                        }
?>

<main>
    <div class="map-container">
    <h1><strong>Peta Kriminalis Kabupaten Banjarnegara</strong></h1>
        <a href="/detail.php">
        ...
        elseif ($_GET['subdit']=='Banjarnegara' or ($_GET['subdit']=='Banjarnegara' and$_GET['by'] == 'jenis') or ($_GET['subdit']=='Banjarnegara' and$_GET['by'] == 'bulan') ) {echo '';}
        ?>


        <?php
        // bulan
        if (in_array($_GET['subdit'],$bulan) or ($_GET['subdit']=='Banjarnegara' and$_GET['by'] == 'bulan')){
        echo "<table>
          <thead>
            <tr>
                <th>No.</th>
      ...
      //			echo  $row["ID"]. $row["Nama Kasus"].  $row["Jenis Tindak Pidana"].   $row["Waktu Kejadian"].  $row["Lokasi Kejadian"]. "<br>";
        ...
        }elseif (($_GET['by'] == 'jenis' and $_GET['subdit'] == 'Banjarnegara') or in_array($_GET['subdit'],$jenis)) {
        // jenis
        echo "<table>
          <thead>
            <tr>
...
?>        
        ...
        }).fitBounds([[-7.696097786180235,109.24129705797112],[-7.043408720998268,110.1566536737751]]);
        ...
        function style_Batas_Kecamatan_BIG_0_0(feature) {
            if (feature.properties['OBJECTID'] >= 573.000000 && feature.properties['OBJECTID'] <= 578.700000 ) {
                return {
            ...
            if (feature.properties['OBJECTID'] >= 578.700000 && feature.properties['OBJECTID'] <= 739.200000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(223,56,43,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 739.200000 && feature.properties['OBJECTID'] <= 764.650000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(231,88,57,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 764.650000 && feature.properties['OBJECTID'] <= 2045.200000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2045.200000 && feature.properties['OBJECTID'] <= 2469.250000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2469.250000 && feature.properties['OBJECTID'] <= 3220.800000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 3220.800000 && feature.properties['OBJECTID'] <= 3595.600000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(254,195,122,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 3595.600000 && feature.properties['OBJECTID'] <= 4128.200000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(254,212,142,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 4128.200000 && feature.properties['OBJECTID'] <= 4462.850000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4462.850000 && feature.properties['OBJECTID'] <= 4533.000000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(255,246,181,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 4533.000000 && feature.properties['OBJECTID'] <= 4703.500000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4703.500000 && feature.properties['OBJECTID'] <= 4972.800000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4972.800000 && feature.properties['OBJECTID'] <= 5194.350000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(211,237,177,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 5194.350000 && feature.properties['OBJECTID'] <= 5212.200000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(193,230,171,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 5212.200000 && feature.properties['OBJECTID'] <= 5230.500000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5230.500000 && feature.properties['OBJECTID'] <= 5384.800000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(151,207,167,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 5384.800000 && feature.properties['OBJECTID'] <= 5973.200000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5973.200000 && feature.properties['OBJECTID'] <= 6472.800000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(97,169,177,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 6472.800000 && feature.properties['OBJECTID'] <= 7236.350000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(70,150,181,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 7236.350000 && feature.properties['OBJECTID'] <= 7243.000000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
...
<div class="title">
<h1><strong><?php if (in_array($_GET['subdit'],$jenis) or ($_GET['subdit'] == 'Banjarnegara' and $_GET['by'] == 'jenis')){echo 'Berdasarkan Bidang Tindak Pidana';}elseif (in_array($_GET['subdit'],$bulan) or ($_GET['by'] == 'bulan' and $_GET['subdit'] == 'Banjarnegara')  ){echo 'Berdasarkan Waktu';} ?></strong></h1>
      </div>
<br>
</main>
