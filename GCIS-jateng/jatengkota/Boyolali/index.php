...
<html lang="en">
    ...
    <body>
        ...
        <header class="header">
            ...
            $filter = $_GET['subdit'];
            if ($_GET['by'] == 'jenis' && $_GET['subdit'] == 'Boyolali') {
            ...
            }elseif (($_GET['subdit'] == 'Boyolali' && $_GET['by'] == 'bulan')) {
...
<?php
                        ...
                        if (in_array($filter,$jenis)){
                           ...
                           $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Boyolali%' AND `Jenis Tindak Pidana` = '$filter'");    
                        }elseif (in_array($filter, $bulan)){
                            $monthName = $filter ; // Indonesian month name
		                    $filter =  array_search($monthName, $bulan) + 1;
                            $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Boyolali%' AND `Waktu Kejadian`LIKE '%2023%$filter-%' ");
                        }else{
                            $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Boyolali%'");
                        }
?>

<main>
    <div class="map-container">
    <h1><strong>Peta Kriminalis Kabupaten Boyolali</strong></h1>
        <a href="/detail.php">
        ...
        elseif ($_GET['subdit']=='Boyolali' or ($_GET['subdit']=='Boyolali' and$_GET['by'] == 'jenis') or ($_GET['subdit']=='Boyolali' and$_GET['by'] == 'bulan') ) {echo '';}
        ?>


        <?php
        // bulan
        if (in_array($_GET['subdit'],$bulan) or ($_GET['subdit']=='Boyolali' and$_GET['by'] == 'bulan')){
        echo "<table>
          <thead>
            <tr>
                <th>No.</th>
      ...
      //			echo  $row["ID"]. $row["Nama Kasus"].  $row["Jenis Tindak Pidana"].   $row["Waktu Kejadian"].  $row["Lokasi Kejadian"]. "<br>";
        ...
        }elseif (($_GET['by'] == 'jenis' and $_GET['subdit'] == 'Boyolali') or in_array($_GET['subdit'],$jenis)) {
        // jenis
        echo "<table>
          <thead>
            <tr>
...
?>        
        ...
        }).fitBounds([[-7.6441814285300556,110.25515767982337],[-7.126815130513796,110.98073236606568]]);
        ...
        function style_Batas_Kecamatan_BIG_0_0(feature) {
            if (feature.properties['OBJECTID'] >= 223.000000 && feature.properties['OBJECTID'] <= 223.958333 ) {
                return {
            ...
            if (feature.properties['OBJECTID'] >= 223.958333 && feature.properties['OBJECTID'] <= 241.416667 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 241.416667 && feature.properties['OBJECTID'] <= 563.250000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(228,77,52,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 563.250000 && feature.properties['OBJECTID'] <= 984.000000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 984.000000 && feature.properties['OBJECTID'] <= 1231.583333 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(241,129,76,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 1231.583333 && feature.properties['OBJECTID'] <= 1736.000000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(248,155,88,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 1736.000000 && feature.properties['OBJECTID'] <= 1889.708333 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(253,178,101,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 1889.708333 && feature.properties['OBJECTID'] <= 2158.666667 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(253,192,117,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 2158.666667 && feature.properties['OBJECTID'] <= 2422.375000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2422.375000 && feature.properties['OBJECTID'] <= 2630.666667 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(254,220,150,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 2630.666667 && feature.properties['OBJECTID'] <= 2792.250000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(254,234,166,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 2792.250000 && feature.properties['OBJECTID'] <= 3423.500000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(255,248,183,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 3423.500000 && feature.properties['OBJECTID'] <= 4067.125000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4067.125000 && feature.properties['OBJECTID'] <= 4194.166667 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(233,246,184,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 4194.166667 && feature.properties['OBJECTID'] <= 4274.000000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4274.000000 && feature.properties['OBJECTID'] <= 4706.333333 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4706.333333 && feature.properties['OBJECTID'] <= 5538.708333 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5538.708333 && feature.properties['OBJECTID'] <= 5628.750000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(175,222,165,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 5628.750000 && feature.properties['OBJECTID'] <= 5747.833333 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(154,209,167,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 5747.833333 && feature.properties['OBJECTID'] <= 6037.333333 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(132,194,171,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 6037.333333 && feature.properties['OBJECTID'] <= 6562.125000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(110,178,175,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 6562.125000 && feature.properties['OBJECTID'] <= 6911.583333 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(88,162,178,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 6911.583333 && feature.properties['OBJECTID'] <= 7435.250000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(65,147,182,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 7435.250000 && feature.properties['OBJECTID'] <= 7441.000000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
...
<div class="title">
<h1><strong><?php if (in_array($_GET['subdit'],$jenis) or ($_GET['subdit'] == 'Boyolali' and $_GET['by'] == 'jenis')){echo 'Berdasarkan Bidang Tindak Pidana';}elseif (in_array($_GET['subdit'],$bulan) or ($_GET['by'] == 'bulan' and $_GET['subdit'] == 'Boyolali')  ){echo 'Berdasarkan Waktu';} ?></strong></h1>
      </div>
<br>
</main>
