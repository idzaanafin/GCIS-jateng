...
<html lang="en">
    ...
    <body>
        ...
        <header class="header">
            ...
            $filter = $_GET['subdit'];
            if ($_GET['by'] == 'jenis' && $_GET['subdit'] == 'Wonogiri') {
            ...
            }elseif (($_GET['subdit'] == 'Wonogiri' && $_GET['by'] == 'bulan')) {
...
<?php
                        ...
                        if (in_array($filter,$jenis)){
                           ...
                           $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Wonogiri%' AND `Jenis Tindak Pidana` = '$filter'");    
                        }elseif (in_array($filter, $bulan)){
                            $monthName = $filter ; // Indonesian month name
		                    $filter =  array_search($monthName, $bulan) + 1;
                            $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Wonogiri%' AND `Waktu Kejadian`LIKE '%2023%$filter-%' ");
                        }else{
                            $result = mysqli_query($conn,"SELECT * FROM `Kasus` WHERE `Lokasi Kejadian` LIKE'Wonogiri%'");
                        }
?>

<main>
    <div class="map-container">
    <h1><strong>Peta Kriminalis Kabupaten Wonogiri</strong></h1>
        <a href="/detail.php">
        ...
        elseif ($_GET['subdit']=='Wonogiri' or ($_GET['subdit']=='Wonogiri' and$_GET['by'] == 'jenis') or ($_GET['subdit']=='Wonogiri' and$_GET['by'] == 'bulan') ) {echo '';}
        ?>


        <?php
        // bulan
        if (in_array($_GET['subdit'],$bulan) or ($_GET['subdit']=='Wonogiri' and$_GET['by'] == 'bulan')){
        echo "<table>
          <thead>
            <tr>
                <th>No.</th>
      ...
      //			echo  $row["ID"]. $row["Nama Kasus"].  $row["Jenis Tindak Pidana"].   $row["Waktu Kejadian"].  $row["Lokasi Kejadian"]. "<br>";
        ...
        }elseif (($_GET['by'] == 'jenis' and $_GET['subdit'] == 'Wonogiri') or in_array($_GET['subdit'],$jenis)) {
        // jenis
        echo "<table>
          <thead>
            <tr>
...
?>        
        ...
        }).fitBounds([[-8.307396813082367,110.66328366156577],[-7.654707747900403,111.57864027736974]]);
        ...
        function style_Batas_Kecamatan_BIG_0_0(feature) {
            if (feature.properties['OBJECTID'] >= 760.000000 && feature.properties['OBJECTID'] <= 762.880000 ) {
                return {
            ...
            if (feature.properties['OBJECTID'] >= 762.880000 && feature.properties['OBJECTID'] <= 1120.880000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 1120.880000 && feature.properties['OBJECTID'] <= 1656.240000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 1656.240000 && feature.properties['OBJECTID'] <= 1856.040000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 1856.040000 && feature.properties['OBJECTID'] <= 1884.200000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 1884.200000 && feature.properties['OBJECTID'] <= 1885.760000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(247,149,86,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 1885.760000 && feature.properties['OBJECTID'] <= 2107.040000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2107.040000 && feature.properties['OBJECTID'] <= 2196.400000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2196.400000 && feature.properties['OBJECTID'] <= 2199.920000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2199.920000 && feature.properties['OBJECTID'] <= 2395.400000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2395.400000 && feature.properties['OBJECTID'] <= 2694.680000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 2694.680000 && feature.properties['OBJECTID'] <= 3278.840000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(255,242,175,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 3278.840000 && feature.properties['OBJECTID'] <= 3951.320000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 3951.320000 && feature.properties['OBJECTID'] <= 4249.680000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(241,249,187,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 4249.680000 && feature.properties['OBJECTID'] <= 4442.400000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4442.400000 && feature.properties['OBJECTID'] <= 4825.920000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 4825.920000 && feature.properties['OBJECTID'] <= 5076.480000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5076.480000 && feature.properties['OBJECTID'] <= 5132.680000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5132.680000 && feature.properties['OBJECTID'] <= 5326.360000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5326.360000 && feature.properties['OBJECTID'] <= 5736.200000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(150,206,168,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 5736.200000 && feature.properties['OBJECTID'] <= 5918.920000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 5918.920000 && feature.properties['OBJECTID'] <= 6180.280000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 6180.280000 && feature.properties['OBJECTID'] <= 6983.480000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
            ...
            if (feature.properties['OBJECTID'] >= 6983.480000 && feature.properties['OBJECTID'] <= 7427.640000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
                ...
                fill: true,
                fillOpacity: 1,
                fillColor: 'rgba(64,146,182,1.0)',
                interactive: true,
            }
            }
            if (feature.properties['OBJECTID'] >= 7427.640000 && feature.properties['OBJECTID'] <= 7467.000000 ) {
                return {
                pane: 'pane_Batas_Kecamatan_BIG_0',
                opacity: 1,
                color: 'rgba(35,35,35,1.0)',
...
<div class="title">
<h1><strong><?php if (in_array($_GET['subdit'],$jenis) or ($_GET['subdit'] == 'Wonogiri' and $_GET['by'] == 'jenis')){echo 'Berdasarkan Bidang Tindak Pidana';}elseif (in_array($_GET['subdit'],$bulan) or ($_GET['by'] == 'bulan' and $_GET['subdit'] == 'Wonogiri')  ){echo 'Berdasarkan Waktu';} ?></strong></h1>
      </div>
<br>
</main>
